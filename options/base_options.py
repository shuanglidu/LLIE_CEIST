...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--input_attnc', type=int, default=1, help='# of input attention image channels')
        self.parser.add_argument('--output_attnc', type=int, default=1, help='# of output attention image channels')
        self.parser.add_argument('--input_nc', type=int, default=3, help='# of input RGB image channels')
        self.parser.add_argument('--output_nc', type=int, default=3, help='# of output RGB image channels')
        self.parser.add_argument('--ngf', type=int, default=64, help='# of gen filters in first conv layer')
        self.parser.add_argument('--ndf', type=int, default=64, help='# of discrim filters in first conv layer')
        self.parser.add_argument('--which_model_net1', type=str, default='unet', help='selects model to use for net1')
